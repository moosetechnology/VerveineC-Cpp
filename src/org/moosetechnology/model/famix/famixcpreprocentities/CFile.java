...
public class CFile extends Entity implements TEntityMetaLevelDependency, TNamedEntity {
    ...
    @FameProperty(name = "parentFolder", opposite = "files", container = true)
    ...
    public void setParentFolder(Folder parentFolder) {
        if (this.parentFolder != null) {
            ...
            this.parentFolder.getFiles().remove(this);
        }
        this.parentFolder = parentFolder;
        if (parentFolder == null) return;
        parentFolder.getFiles().add(this);
    }
