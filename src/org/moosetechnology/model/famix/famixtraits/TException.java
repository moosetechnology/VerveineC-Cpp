...
public interface TException extends TNamedEntity, TClass, TWithAttributes, TWithMethods, TSourceEntity, TEntityMetaLevelDependency, TReferenceable, TWithInheritances, TInvocationsReceiver, TType, TPackageable, TWithComments {
