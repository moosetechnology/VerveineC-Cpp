...
public class FamixCEntitiesModel {
    ...
    public static void importInto(MetaRepository metamodel) {
		...
		metamodel.with(org.moosetechnology.famix.famixcentities.DerefInvocation.class);
		...
		metamodel.with(org.moosetechnology.famix.famixcentities.FileAnchor.class);
		metamodel.with(org.moosetechnology.famix.famixcentities.Function.class);
		metamodel.with(org.moosetechnology.famix.famixcentities.GlobalVar.class);
		metamodel.with(org.moosetechnology.famix.famixcentities.Invocation.class);
		metamodel.with(org.moosetechnology.famix.famixcentities.LocalVar.class);
