...
import org.moosetechnology.famix.famixtraits.TDereferencedInvocation;
...
public class DerefInvocation extends Invocation implements TAssociation, TAssociationMetaLevelDependency, TDereferencedInvocation, TInvocation, TSourceEntity {
        ...
        if (candidates == null) {
            candidates = new MultivalueSet<TInvocable>() {
                ...
                protected void clearOpposite(TInvocable e) {
                    e.getIncomingInvocations().remove(DerefInvocation.this);
                }
                @Override
                protected void setOpposite(TInvocable e) {
                    e.getIncomingInvocations().add(DerefInvocation.this);
                }
            };
        }
        return candidates;
