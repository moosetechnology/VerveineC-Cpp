...
@FameDescription("StructuredType")
public class StructuredType extends Type implements TWithAttributes, TWithComments {
        ...
        if (attributes == null) {
            attributes = new MultivalueSet<TAttribute>() {
                ...
                protected void setOpposite(TAttribute e) {
                    e.setParentType(StructuredType.this);
                }
            };
        }
        return attributes;
        ...
        if (comments == null) {
            comments = new MultivalueSet<TComment>() {
                ...
                protected void setOpposite(TComment e) {
                    e.setContainer(StructuredType.this);
                }
            };
        }
        return comments;
